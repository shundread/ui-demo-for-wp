...
export function GatewayList() {
  ...
  const [gatewayStatusFilter, setGatewayStatusFilter] =
  ...
  const sortedAndFilteredGateways = gatewaySort(gateways, sortingPolicy)
    ...
    .filter(
      (gateway) =>
        gatewayStatusFilter === null || gateway.status === gatewayStatusFilter,
    )
          ...
          <tr>
            ...
            <th>
              <input
                ...
                onChange={(event) =>
                  setGatewayDescriptionFilter(event.target.value)
                }
              />
            </th>
            <th>
            ...
            <th>
              <input
                ...
                onChange={(event) =>
                  setGatewayVersionFilter(event.target.value)
                }
              />
            </th>
            <th colSpan={2}>
          ...
          <tr>
            ...
            <th scope="col">
              ...
              >
                ...
                {sortingPolicy === SortingPolicy.StatusDesc ? (
                  <ArrowDown />
                ) : null}
              </button>
            </th>
            ...
            <th scope="col">
              ...
              >
                ...
                {sortingPolicy === SortingPolicy.LatestDesc ? (
                  <ArrowDown />
                ) : null}
              </button>
            </th>
  ...
  switch (sortingPolicy) {
    ...
    case SortingPolicy.LatestAsc:
      return gateways.sort((a, b) =>
        a.latestMessageTime < b.latestMessageTime ? -1 : 1,
      );
