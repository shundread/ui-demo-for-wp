...
export function GatewayDetailBasicInfo({ uuid, description, model, version }: GatewayDetailBasicInfoProps) {
    return (
        <section>
            <h2>Basic info</h2>
            <dl>
                ...
                <dd>{model && version ? `${model}, version ${version}` : "data not found"}</dd>
            </dl>
        </section>
    )
}